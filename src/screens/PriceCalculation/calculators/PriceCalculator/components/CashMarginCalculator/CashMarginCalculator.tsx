	...
	return (
		<div>
			...
			<Box display={"flex"} justifyContent="space-between">
				<Box>
					<p className="small fcolor-body">113</p>
				</Box>
				<Box>
					<p className="small fcolor-body">242</p>
				</Box>
			</Box>
			...
			<Grid container justifyContent={"space-between"} marginBottom={2}>
				...
				<Grid item xs={6} padding={"10px"}>
					<p className="body fcolor-onyx">{3234}</p>
				</Grid>
			</Grid>
			<Grid container justifyContent={"space-between"} marginBottom={2}>
				<Grid item xs={6} padding={"10px"}>
				...
				<Grid item xs={6} padding={"10px"}>
					<p className="body fcolor-onyx">%</p>
				</Grid>
			</Grid>
			<Box
				width={"100%"}
			...
			<Grid container justifyContent={"space-between"}>
				...
				<Grid item xs={6} padding={"10px"}>
					<p className="body fw-bold fcolor-onyx"></p>
				</Grid>
			</Grid>
		</div>
	);
